...
import { Download, Trash2, Copy, Play, Pause, ChevronRight, Check, Plus, Save, Upload, Info } from 'lucide-react';
...
function SimpleModal({ title, onClose, children }) {
  ...
  return (
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-30">
      ...
      <div className="bg-white rounded-lg shadow-lg p-4 min-w-[300px] max-w-[90vw]">
...
export default function AnimationCreator() {
  ...
  const floodFill = (canvas, startX, startY, newColorHex) => {
  ...
  return (
    ...
    <div className="flex flex-col h-dvh p-2 sm:p-4 bg-gray-100 font-sans text-gray-800">
      ...
      <h1 className="text-xl sm:text-2xl font-bold mb-2 sm:mb-4 text-center">Frame Animation Creator</h1>
        ...
        <div className="w-full lg:w-56 flex flex-col gap-4 p-3 bg-white rounded-lg shadow-md order-2 lg:order-1 overflow-y-auto">
          ...
          <div className="flex flex-col gap-2 mt-auto border-t pt-2">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 p-2 bg-green-500 text-white rounded hover:bg-green-600 text